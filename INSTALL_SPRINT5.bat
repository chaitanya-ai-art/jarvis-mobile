...
if not exist "%TARGET%" (
  ...
  echo Install the earlier Jarvis sprints first.
  pause
  exit /b 1
)
echo Installing Jarvis Sprint 5 Voice Assistant...
...
echo.
echo Sprint 5 installed. Existing token and database were preserved.
